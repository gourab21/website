            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6 md:w-2/3">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                  <span className="text-gradient block">John Doe</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-4">
                  <Link to="/resume" className="px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors">
                    View Resume
                  </Link>
              ...
              {/* Professional Image with Animation */}
              <div className="md:block w-60 h-60 lg:w-72 lg:h-72 relative">
                <div className="w-full h-full rounded-full bg-gradient-to-tr from-primary/20 to-primary/10 flex items-center justify-center overflow-hidden border border-white/10 relative">
                  ...
                  {/* Person image instead of JD text */}
